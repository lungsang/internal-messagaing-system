...
class MessagesController extends Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        //By Default show the incoming data when visiting message
        $type = 'inbox';
        
        return view('messenger.index', compact('type'));
    }


    /**
     * Show all of the message threads sent by the user.
     *
     * @return mixed
     */
